...
function setChartHeight(iframe) {
    if(iframe == 'fixed') {
        ...
        document.getElementsByClassName('container')[0].style.height = '844px';
        document.getElementsByClassName('main')[0].style.height = '816px';
        ...
        let height = 816; //Altura total del main
